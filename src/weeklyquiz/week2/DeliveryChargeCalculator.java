...
public interface DeliveryChargeCalculator {
    ...
    BigDecimal getDeliveryCharge(BigDecimal weight, BigDecimal price);
...
//            deliveryCharge.add(WEIGHT_CHARGE_1);
//        } else if (weight.compareTo(WEIGHT_STANDARD_2) < ZERO) {
//            deliveryCharge.add(WEIGHT_CHARGE_2);
//        } else {
//            deliveryCharge.add(WEIGHT_CHARGE_3);
//        }

        //가격에 따른 할인 측정
//        if(price.compareTo(PRICE_STANDARD_2)>ZERO){
//            deliveryCharge.multiply(PRICE_DISCOUNT_ALL);
//        }else if(price.compareTo(PRICE_STANDARD_1) > ZERO){
//            deliveryCharge.subtract(PRICE_DISCOUNT);
//        }
//
